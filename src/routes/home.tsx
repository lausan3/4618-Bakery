...
const Home = () => {
  const images = [
    './src/assets/IMG_6042.PNG',
    './src/assets/IMG_6043.PNG',
    './src/assets/IMG_6044.PNG',
    './src/assets/IMG_6045.PNG',
    './src/assets/IMG_6046.PNG',
    './src/assets/IMG_6050.PNG',
    './src/assets/IMG_6051.PNG',
    './src/assets/IMG_6052.PNG',
    './src/assets/IMG_6053.PNG',
    './src/assets/IMG_6054.PNG',
    './src/assets/IMG_6055.PNG',
    './src/assets/_com.apple.Pasteboard.Aydaf0.PNG',
    './src/assets/_com.apple.Pasteboard.Pa3lOk.PNG',
    './src/assets/_com.apple.Pasteboard.S9ZbU9.PNG',
    './src/assets/_com.apple.Pasteboard.tfHHHi.PNG',
    './src/assets/IMG_1155.png',
  ];
  ...
  return (
    ...
    ">
      ...
      ">
        ...
        <img src="./src/assets/IMG_0003.PNG" alt="Showcase Cake" className="
          p-10
